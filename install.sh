...
echo "Downloading pve-docker-rollback..."
curl -fsSL "$REPO_URL/pve-docker-rollback" -o "$INSTALL_DIR/pve-docker-rollback"
...
chmod +x "$INSTALL_DIR/pve-docker-rollback"
...
echo ""
echo "  Rollback the fix (when no longer needed):"
echo "    pve-docker-rollback <container-id>"
echo "    pve-docker-rollback --list"
echo "    pve-docker-rollback --all"
echo ""
echo "Examples:"
